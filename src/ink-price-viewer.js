...
const COPY={
  ...
  ja:{title:'公式インク小分け価格表',intro:'店頭案内とブランド別の5ml・10ml価格を原本画像で確認できます。',tabs:['ご利用案内','価格表 1','価格表 2','価格表 3'],zoomOut:'縮小',zoomIn:'拡大',reset:'画面に合わせる',full:'大きく表示',loading:'価格表を読み込んでいます。',page:'現在のページ',source:'原本案内',sourceCopy:'価格と小分け可否は変更される場合があります。お会計前に色・容量・金額をスタッフとご確認ください。',previous:'前へ',next:'次へ',share:'現在のページを共有',shared:'価格表リンクをコピーしました。',notices:['価格表にないブランド、一部の限定品・セット商品は小分け対象外です。','混雑時や在庫不足時は準備に時間がかかったり、販売容量が変わる場合があります。','価格は5mlと10mlで表示されています。','お会計前にインク色、金額、容器の密閉状態をスタッフとご確認ください。']},
  'zh-Hans':{title:'官方墨水分装价格表',intro:'可通过官方原图查看门店说明及各品牌5ml、10ml分装价格。',tabs:['使用说明','价格表 1','价格表 2','价格表 3'],zoomOut:'缩小',zoomIn:'放大',reset:'适应画面',full:'大图查看',loading:'正在加载价格表。',page:'当前页面',source:'原始说明',sourceCopy:'价格与可分装情况可能会变更。付款前请与店员确认颜色、容量和最终金额。',previous:'上一页',next:'下一页',share:'分享当前页面',shared:'价格表链接已复制。',notices:['价格表中未列出的品牌以及部分限定款、套装不提供分装。','门店繁忙或库存不足时，准备时间可能延长，销售容量也可能调整。','价格按5ml和10ml标示。','付款前请与店员确认墨水颜色、金额及容器密封状态。']},
  'zh-Hant':{title:'官方墨水分裝價格表',intro:'可透過官方原圖查看門市說明及各品牌5ml、10ml分裝價格。',tabs:['使用說明','價格表 1','價格表 2','價格表 3'],zoomOut:'縮小',zoomIn:'放大',reset:'適應畫面',full:'大圖查看',loading:'正在載入價格表。',page:'目前頁面',source:'原始說明',sourceCopy:'價格與可分裝情況可能會變更。付款前請與店員確認顏色、容量和最終金額。',previous:'上一頁',next:'下一頁',share:'分享目前頁面',shared:'價格表連結已複製。',notices:['價格表中未列出的品牌以及部分限定款、套裝不提供分裝。','門市繁忙或庫存不足時，準備時間可能延長，銷售容量也可能調整。','價格按5ml和10ml標示。','付款前請與店員確認墨水顏色、金額及容器密封狀態。']}
};
