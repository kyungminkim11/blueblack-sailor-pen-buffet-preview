const BRAND_META=[
  {keys:['sailor','세일러'],label:'SAILOR',country:'JP',tone:'navy',image:'https://sailor.co.jp/wp-content/themes/sailor-wordpress/img/header/HeaderMainMenu__logo.png'},
  {keys:['pilot','파이롯트','파일럿'],label:'PILOT',country:'JP',tone:'blue',image:'https://www.pilot.co.jp/asset_new2026/image/common/header_01.svg'},
  ...
  {keys:['lamy','라미'],label:'LAMY',country:'DE',tone:'black',image:'https://a.storyblok.com/f/302549/378x87/fa8f9a5c70/lamy-logo.svg/m/500x'},
  {keys:['platinum','플래티넘'],label:'PLATINUM',country:'JP',tone:'black',image:'https://www.platinum-pen.co.jp/common/img/parts/logo.svg'},
  ...
  {keys:['colorverse','컬러버스'],label:'COLORVERSE',country:'KR',tone:'violet',image:'https://plnbee.cafe24.com/Colorverse/CI/LOGO_new.png'},
