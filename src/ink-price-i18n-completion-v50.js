...
const INK_EXTRA={
  ko:{title:'블루블랙 잉크 소분 가격 검색',meta:'블루블랙에서 취급하는 잉크를 브랜드·시리즈·색상명으로 검색하고 5ml·10ml 소분 가격과 본병 정보를 확인하세요.',app:'잉크 소분 가격 검색',notices:'잉크 소분 이용 안내',viewer:'공식 잉크 소분 가격표',tabs:'가격표 페이지',sheet:'블루블랙 잉크 소분 가격표',expanded:'확대한 잉크 소분 가격표',close:'확대 화면 닫기'},
  en:{title:'BlueBlack Ink Decant Price Search',meta:'Search BlueBlack Pen Shop inks by brand, series or color and compare 5ml and 10ml decant prices with full-bottle information.',app:'Ink decant price search',notices:'Ink decant guidance',viewer:'Official ink decant price sheets',tabs:'Price sheet pages',sheet:'BlueBlack ink decant price sheet',expanded:'Enlarged ink decant price sheet',close:'Close enlarged view'},
  ja:{title:'BlueBlack インク小分け価格検索',meta:'BlueBlack Pen Shopのインクをブランド・シリーズ・色名から検索し、5ml・10mlの小分け価格とボトル情報を確認できます。',app:'インク小分け価格検索',notices:'インク小分けのご案内',viewer:'公式インク小分け価格表',tabs:'価格表ページ',sheet:'BlueBlackインク小分け価格表',expanded:'拡大したインク小分け価格表',close:'拡大画面を閉じる'},
  'zh-Hans':{title:'BlueBlack 墨水分装价格查询',meta:'按品牌、系列或颜色搜索BlueBlack Pen Shop墨水，并比较5ml、10ml分装价格与原装瓶信息。',app:'墨水分装价格查询',notices:'墨水分装说明',viewer:'官方墨水分装价格表',tabs:'价格表页面',sheet:'BlueBlack墨水分装价格表',expanded:'放大的墨水分装价格表',close:'关闭放大画面'},
  'zh-Hant':{title:'BlueBlack 墨水分裝價格查詢',meta:'依品牌、系列或顏色搜尋BlueBlack Pen Shop墨水，並比較5ml、10ml分裝價格與原裝瓶資訊。',app:'墨水分裝價格查詢',notices:'墨水分裝說明',viewer:'官方墨水分裝價格表',tabs:'價格表頁面',sheet:'BlueBlack墨水分裝價格表',expanded:'放大的墨水分裝價格表',close:'關閉放大畫面'}
};
