...
const asCopy={
  ...
  vi:{title:'Hướng dẫn dịch vụ sau bán hàng',intro:'Xem chính sách riêng của Pen Buffet cùng trung tâm dịch vụ chính thức, liên hệ, địa chỉ và lưu ý chi phí theo từng thương hiệu.',search:'Tìm thương hiệu',placeholder:'Ví dụ: Lamy, Sailor, Pilot, Parker',shown:n=>`Đang hiển thị ${n} trung tâm dịch vụ.`,empty:'Không tìm thấy thương hiệu phù hợp.',quickTitle:'Thương hiệu phổ biến',quickHint:'Chọn nhanh thương hiệu thường được tìm kiếm.',showAll:'Xem tất cả thương hiệu',hideAll:'Đóng danh sách thương hiệu',allTitle:'Tất cả 25 thương hiệu',allHint:'Chọn một thương hiệu để chỉ hiển thị trung tâm dịch vụ tương ứng.',penTitle:'Dịch vụ và hướng dẫn mua Pen Buffet',penIntro:'Sản phẩm Pen Buffet áp dụng chính sách dịch vụ riêng của BlueBlack.',nib:'Ngòi bút',nibBody:'Chỉ có ngòi MF.',included:'Bộ cơ bản',includedBody:'Kèm 2 ống mực màu đen.',converter:'Bộ bơm mực',converterBody:'Không nằm trong bộ cơ bản và được bán riêng.',extra:'Bộ phận màu bổ sung',extraBody:'Chỉ có thể mua thêm bộ phận màu trong ngày mua thân bút.',service:'Dịch vụ riêng',serviceBody:'Chỉ tiếp nhận tại BlueBlack Pen Shop, không giới hạn thời gian và không thu phí kiểm tra. Có thể phát sinh phí khi thay linh kiện.',gift:'Cách tính quà tặng',giftBody:'Giá trị Pen Buffet không được cộng vào mức quà tặng.',openPen:'Mở Pen Buffet',call:'Gọi cửa hàng'},
  id:{title:'Panduan layanan purnajual',intro:'Lihat kebijakan khusus Pen Buffet serta pusat servis resmi, kontak, alamat, dan catatan biaya untuk setiap merek.',search:'Cari merek',placeholder:'Contoh: Lamy, Sailor, Pilot, Parker',shown:n=>`${n} pusat servis ditampilkan.`,empty:'Merek yang sesuai tidak ditemukan.',quickTitle:'Merek populer',quickHint:'Pilih cepat merek yang sering dicari.',showAll:'Lihat semua merek',hideAll:'Tutup daftar merek',allTitle:'Semua 25 merek',allHint:'Pilih merek untuk hanya menampilkan pusat servis resminya.',penTitle:'Panduan servis dan pembelian Pen Buffet',penIntro:'Produk Pen Buffet mengikuti kebijakan servis khusus BlueBlack.',nib:'Mata pena',nibBody:'Hanya tersedia ukuran MF.',included:'Isi paket',includedBody:'Termasuk 2 kartrid tinta hitam.',converter:'Konverter',converterBody:'Tidak termasuk dan dijual terpisah.',extra:'Komponen warna tambahan',extraBody:'Komponen warna tambahan hanya dapat dibeli pada hari yang sama dengan pena utama.',service:'Servis khusus',serviceBody:'Hanya tersedia di BlueBlack Pen Shop, tanpa batas waktu atau biaya pemeriksaan. Penggantian komponen dapat dikenakan biaya.',gift:'Perhitungan hadiah',giftBody:'Pembelian Pen Buffet tidak dihitung dalam total nilai hadiah.',openPen:'Buka Pen Buffet',call:'Telepon toko'},
  th:{title:'คู่มือบริการหลังการขาย',intro:'ตรวจสอบนโยบายเฉพาะของ Pen Buffet พร้อมศูนย์บริการอย่างเป็นทางการ ข้อมูลติดต่อ ที่อยู่ และข้อควรทราบเรื่องค่าใช้จ่ายของแต่ละแบรนด์',search:'ค้นหาแบรนด์',placeholder:'เช่น Lamy, Sailor, Pilot, Parker',shown:n=>`แสดงศูนย์บริการ ${n} แห่ง`,empty:'ไม่พบแบรนด์ที่ตรงกัน',quickTitle:'แบรนด์ยอดนิยม',quickHint:'เลือกแบรนด์ที่ค้นหาบ่อยได้อย่างรวดเร็ว',showAll:'ดูแบรนด์ทั้งหมด',hideAll:'ปิดรายชื่อแบรนด์',allTitle:'แบรนด์ทั้งหมด 25 แบรนด์',allHint:'เลือกแบรนด์เพื่อแสดงเฉพาะศูนย์บริการอย่างเป็นทางการที่เกี่ยวข้อง',penTitle:'คู่มือบริการและการซื้อ Pen Buffet',penIntro:'ผลิตภัณฑ์ Pen Buffet ใช้นโยบายบริการเฉพาะของ BlueBlack',nib:'หัวปากกา',nibBody:'มีเฉพาะขนาด MF',included:'อุปกรณ์พื้นฐาน',includedBody:'มาพร้อมตลับหมึกสีดำ 2 หลอด',converter:'คอนเวอร์เตอร์',converterBody:'ไม่รวมในชุดพื้นฐานและจำหน่ายแยก',extra:'ชิ้นส่วนสีเพิ่มเติม',extraBody:'ซื้อชิ้นส่วนสีเพิ่มเติมได้เฉพาะวันเดียวกับที่ซื้อปากกาหลัก',service:'บริการเฉพาะ',serviceBody:'รับบริการเฉพาะที่ BlueBlack Pen Shop ไม่มีการจำกัดระยะเวลาและไม่มีค่าตรวจสอบ แต่อาจมีค่าใช้จ่ายเมื่อเปลี่ยนชิ้นส่วน',gift:'เกณฑ์ของขวัญ',giftBody:'ยอดซื้อ Pen Buffet ไม่รวมในการคำนวณมูลค่าของขวัญ',openPen:'เปิด Pen Buffet',call:'โทรหาร้าน'}
};
...
function asLang(){const raw=(new URLSearchParams(location.search).get('lang')||localStorage.getItem('blueblack-language')||navigator.language||'ko').toLowerCase();if(raw.includes('hant')||raw.startsWith('zh-tw')||raw.startsWith('zh-hk'))return'zh-Hant';if(raw.startsWith('zh'))return'zh-Hans';if(raw.startsWith('vi'))return'vi';if(raw.startsWith('id'))return'id';if(raw.startsWith('th'))return'th';if(raw.startsWith('ja'))return'ja';if(raw.startsWith('en'))return'en';return'ko';}
