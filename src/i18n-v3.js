...
const messages = {
  ...
  en: {
    ...
    resultTitle: 'Your selected combination', resultCopy: 'Compare this list with the physical parts in store.', share: 'Share combination', saveImage: 'Save combination image', staffView: 'Review with staff', reset: 'Create a new combination',
    shared: 'Combination shared.', copied: 'Combination link copied.', imageSaved: 'Combination image saved.', resetDone: 'Reset to the default combination.',
  ...
  ja: {
    ...
    resultTitle: '選択した組み合わせ', resultCopy: '店頭の実物パーツと下記の内容を比較してください。', share: '組み合わせを共有', saveImage: '組み合わせ画像を保存', staffView: 'スタッフと確認', reset: '新しい組み合わせを作る',
    shared: '組み合わせを共有しました。', copied: '組み合わせリンクをコピーしました。', imageSaved: '組み合わせ画像を保存しました。', resetDone: '初期の組み合わせに戻しました。',
