...
.ink-store-quick-nav .ink-store-quick{min-width:0;margin:0;padding:5px 2px;overflow-x:auto;overflow-y:hidden;overscroll-behavior-x:contain;scroll-behavior:smooth;scroll-snap-type:x proximity;touch-action:pan-x;-webkit-overflow-scrolling:touch}
